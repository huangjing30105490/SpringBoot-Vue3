      ...
      <el-form ref="formRef" :model="data.form" :rules="data.rules">
        ...
        <el-form-item prop="role">
          <el-select size="large" style="width: 100%" v-model="data.form.role">
            <el-option label="校级管理" value="ADMIN"></el-option>
            <el-option label="院系管理" value="USER"></el-option>
            <el-option label="教师用户" value="TEACHER"></el-option>
          </el-select>
        </el-form-item>
