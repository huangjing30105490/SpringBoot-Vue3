  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 5px">
      <el-table :data="data.tableData" style="width: 100%" :header-cell-style="{ color: '#333', backgroundColor: '#eaf4ff' }">
        <el-table-column prop="img" label="培训课程">
        ...
        <el-table-column prop="author" label="培训教师" />
        <el-table-column prop="num" label="剩余名额" />
    ...
    <el-dialog title="培训信息" v-model="data.formVisible" width="30%" destroy-on-close>
      <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="80px" style="padding: 20px 30px 10px 0">
        <el-form-item prop="img" label="培训课程">
          <el-upload
        ...
        <el-form-item prop="author" label="培训教师">
          <el-input v-model="data.form.author" autocomplete="off" placeholder="请输入培训教师" />
        </el-form-item>
...
const data = reactive({
  ...
  rules: {
    ...
    num: [
      { required: true, message: '请填写图书数量', trigger: 'blur' }
    ],
  }
})
